                               ...
                               target="<?php echo esc_attr($cta_link['target'] ?? '_self'); ?>">
                                ...
                                <span class="hero__link-icon" aria-hidden="true">
                                    ...
                                    <?php elseif (!empty($cta_icon['url'])) : ?>
                                        <img class="hero__link-icon-image"
                    ...
                    <?php if ($has_cert) : ?>
                        <div class="hero__certification">
                            ...
                            <?php elseif (!empty($cert_icon['url'])) : ?>
                                <img class="hero__certification-icon"
                                     src="<?php echo esc_url($cert_icon['url']); ?>"
                                     alt=""
                                     loading="lazy" />
                            <?php endif; ?>
            ...
            <aside class="hero__reviews" aria-label="<?php echo esc_attr__('Review highlights', 'atomic-design'); ?>">
                ...
                <div class="hero__review-copy">
                    ...
                    <?php if ($review_rating > 0) : ?>
                        <div class="hero__stars" aria-label="<?php echo esc_attr(sprintf(__('%d out of 5 stars', 'atomic-design'), $review_rating)); ?>">
                ...
                <?php if (!empty($bbb_logo['ID']) || !empty($bbb_logo['url']) || $bbb_text !== '') : ?>
                    <div class="hero__bbb">
                        ...
                        <?php elseif (!empty($bbb_logo['url'])) : ?>
                            <img class="hero__bbb-logo"
                                 src="<?php echo esc_url($bbb_logo['url']); ?>"
                                 alt="<?php echo esc_attr($bbb_text); ?>"
                                 loading="lazy" />
                        <?php elseif ($bbb_text !== '') : ?>
