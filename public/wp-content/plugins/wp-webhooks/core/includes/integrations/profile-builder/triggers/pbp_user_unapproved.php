  ...
  class WP_Webhooks_Integrations_profile_builder_Triggers_pbp_user_unapproved {
	...
	public function get_details(){
        ...
        $description = WPWHPRO()->webhook->get_endpoint_description( 'trigger', array(
            'webhook_name' => 'User unapproved',
            'webhook_slug' => 'pbp_user_unapproved',
            'post_delay' => true,
            'trigger_hooks' => array(
                array(
                    'hook' => 'wppb_after_user_unapproval',
		...
		return array(
			...
			'short_description' => __( 'This webhook fires as soon as a user is unapproved within Profile Builder.', 'wp-webhooks' ),
