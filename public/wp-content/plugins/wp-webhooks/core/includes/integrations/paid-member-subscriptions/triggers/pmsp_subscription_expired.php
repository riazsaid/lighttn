    ...
    class WP_Webhooks_Integrations_paid_member_subscriptions_Triggers_pmsp_subscription_expired {
        ...
        public function get_callbacks(){
            ...
            return array(
                array(
                    ...
                    'callback' => array( $this, 'pms_member_subscription_expired_callback' ),
                    'priority' => 20,
                    'arguments' => 3,
                    'delayed' => true,
                ),
        ...
        public function get_details(){
            ...
            return array(
                ...
                'short_description' => __( 'This webhook fires as soon as a member subscription has expired within Paid Member Subscriptions.', 'wp-webhooks' ),
        ...
        public function pms_member_subscription_expired_callback( $id, $new_data, $old_data ){
