		...
		<div class="dci-notice">
			<div class="dci-notice-wrapper">
				...
				<img src="plugins_url( 'assets/images/logo.png', __FILE__ );" alt="logo">
					...
					<h2 class="dci-title">
						<?php esc_html_e( 'Never miss an important update.', 'semantic-linkboss' ); ?>
					</h2>
					<p class="dci-desc">
						<?php esc_html_e( 'Get notified when there are new updates available for your plugins and themes. In the current version of this message it is clear that you are being sent a confirmation email to confirm your opt-in.', 'semantic-linkboss' ); ?>
					</p>
				</div>
				<div class="dci-actions">
					...
					<form method="get" class="dci-notice-data">
						...
						<button id="dci_allow_yes" name="dci_allow_status" value="yes" type="button"
							...
							<?php esc_html_e( 'Allow & Continue', 'semantic-linkboss' ); ?>
						</button>
						<button id="dci_allow_skip" name="dci_allow_status" value="skip" type="button"
							class="dci-button-skip button button-secondary">
							<?php esc_html_e( 'Skip', 'semantic-linkboss' ); ?>
						</button>
					</form>
				</div>
				<div class="dci-permission">
					<p>
						<?php esc_html_e( 'Which permission are being granted?', 'semantic-linkboss' ); ?>
					</p>
				</div>
					...
					<ul>
						<li>
							<div class="dci-permission-item">
								...
								<div class="dci-desc">
									<h3>
										<?php esc_html_e( 'View Basic Profile Info.', 'semantic-linkboss' ); ?>
									</h3>
									<p>
										<?php esc_html_e( 'Your WordPress user\'s first & last name, and email address.', 'semantic-linkboss' ); ?>
									</p>
								</div>
							</div>
						</li>
						<li>
							<div class="dci-permission-item">
								...
								<div class="dci-desc">
									<h3>
										<?php esc_html_e( 'View Basic Website Info.', 'semantic-linkboss' ); ?>
									</h3>
									<p>
										<?php esc_html_e( 'Homepage URL & title, WP & PHP versions, and site language.', 'semantic-linkboss' ); ?>
									</p>
								</div>
							</div>
						</li>
						<li>
							<div class="dci-permission-item">
								...
								<div class="dci-desc">
									<h3>
										<?php esc_html_e( 'View Basic Plugin Info.', 'semantic-linkboss' ); ?>
									</h3>
									<p>
										<?php esc_html_e( 'Current Plugin & SDK versions, and if active or uninstalled.', 'semantic-linkboss' ); ?>
									</p>
								</div>
							</div>
						</li>
