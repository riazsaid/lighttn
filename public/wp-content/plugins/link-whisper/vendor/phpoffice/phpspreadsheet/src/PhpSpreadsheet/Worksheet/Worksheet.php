...
use LWVendor\PhpOffice\PhpSpreadsheet\Cell\AddressRange;
use LWVendor\PhpOffice\PhpSpreadsheet\Cell\Cell;
use LWVendor\PhpOffice\PhpSpreadsheet\Cell\CellAddress;
use LWVendor\PhpOffice\PhpSpreadsheet\Cell\CellRange;
...
use LWVendor\PhpOffice\PhpSpreadsheet\Cell\IValueBinder;
...
class Worksheet implements IComparable
{
    ...
    private function getWorksheetAndCoordinate(string $coordinate) : array
    {
        ...
        } elseif (!\preg_match('/^' . Calculation::CALCULATION_REGEXP_CELLREF . '$/i', $coordinate) && \preg_match('/^' . Calculation::CALCULATION_REGEXP_DEFINEDNAME . '$/iu', $coordinate)) {
            // Named range?
