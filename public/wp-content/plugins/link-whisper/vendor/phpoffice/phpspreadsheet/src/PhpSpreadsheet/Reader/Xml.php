...
use DateTime;
use DateTimeZone;
use LWVendor\PhpOffice\PhpSpreadsheet\Cell\AddressHelper;
...
use LWVendor\PhpOffice\PhpSpreadsheet\Reader\Xml\PageSettings;
use LWVendor\PhpOffice\PhpSpreadsheet\Reader\Xml\Properties;
use LWVendor\PhpOffice\PhpSpreadsheet\Reader\Xml\Style;
...
class Xml extends BaseReader
{
    ...
    {
        try {
            $xml = \simplexml_load_string($this->getSecurityScannerOrThrow()->scan($this->fileContents ?: \file_get_contents($filename)), 'SimpleXMLElement', Settings::getLibXmlLoaderOptions());
        } catch (\Exception $e) {
