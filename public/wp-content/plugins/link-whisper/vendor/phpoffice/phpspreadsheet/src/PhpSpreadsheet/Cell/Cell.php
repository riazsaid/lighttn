...
use LWVendor\PhpOffice\PhpSpreadsheet\Shared\Date as SharedDate;
use LWVendor\PhpOffice\PhpSpreadsheet\Shared\StringHelper;
use LWVendor\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\CellStyleAssessor;
use LWVendor\PhpOffice\PhpSpreadsheet\Style\NumberFormat;
use LWVendor\PhpOffice\PhpSpreadsheet\Style\Style;
use LWVendor\PhpOffice\PhpSpreadsheet\Worksheet\Table;
    ...
    public static function setCalculateDateTimeType(int $calculateDateTimeType) : void
    {
        switch ($calculateDateTimeType) {
            ...
            case self::CALCULATE_TIME_FLOAT:
                ...
                break;
            default:
                throw new \LWVendor\PhpOffice\PhpSpreadsheet\Calculation\Exception("Invalid value {$calculateDateTimeType} for calculated date time type");
        }
    }
    /**
    ...
    public function getCalculatedValue(bool $resetLog = \true)
    {
        if ($this->dataType === DataType::TYPE_FORMULA) {
            try {
                ...
                throw new \LWVendor\PhpOffice\PhpSpreadsheet\Calculation\Exception($this->getWorksheet()->getTitle() . '!' . $this->getCoordinate() . ' -> ' . $ex->getMessage(), $ex->getCode(), $ex);
            }
