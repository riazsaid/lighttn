...
class Style extends WriterPart
{
     ...
     * Write Cell Style Xf.
     */
    private function writeCellStyleXf(XMLWriter $objWriter, \LWVendor\PhpOffice\PhpSpreadsheet\Style\Style $style, Spreadsheet $spreadsheet, string $defaultAlignHash) : void
    {
        // xf
        $objWriter->startElement('xf');
        $objWriter->writeAttribute('xfId', '0');
     ...
     */
    private function writeCellStyleDxf(XMLWriter $objWriter, \LWVendor\PhpOffice\PhpSpreadsheet\Style\Style $style) : void
    {
        // dxf
