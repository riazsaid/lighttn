...
use LWVendor\PhpOffice\PhpSpreadsheet\Chart\AxisText;
use LWVendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor;
...
use LWVendor\PhpOffice\PhpSpreadsheet\Chart\Properties as ChartProperties;
use LWVendor\PhpOffice\PhpSpreadsheet\Chart\Title;
use LWVendor\PhpOffice\PhpSpreadsheet\Chart\TrendLine;
use LWVendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx;
...
class Chart
{
    ...
    public function readChart(SimpleXMLElement $chartElements, $chartName)
    {
        ...
        $chart = new \LWVendor\PhpOffice\PhpSpreadsheet\Chart\Chart($chartName, $title, $legend, $plotArea, $plotVisOnly, (string) $dispBlanksAs, $XaxisLabel, $YaxisLabel, $xAxis, $yAxis);
        if ($chartNoFill) {
            $chart->setNoFill(\true);
        }
