    ...
    public function registerModule($module, $overload = \false)
    {
        if (\is_string($module)) {
            ...
            if (!$ok) {
                ...
                if (!\class_exists($module)) {
                    \trigger_error($original_module . ' module does not exist', \E_USER_ERROR);
                    return;
                }
            }
            $module = new $module();
...
\class_alias('LWVendor\\HTMLPurifier_HTMLModuleManager', 'HTMLPurifier_HTMLModuleManager', \false);
// vim: et sw=4 sts=4
