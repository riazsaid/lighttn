<div class="wpil-collapsible-wrapper" <?php echo Wpil_Toolbox::output_dropdown_wrapper_atts($data); ?>>
    <div class="wpil-collapsible wpil-collapsible-static wpil-links-count <?php echo (!empty($links)) ? 'wpil-collapsible-has-data': 'wpil-collapsible-no-data';?>"><?=count($links)?></div>
