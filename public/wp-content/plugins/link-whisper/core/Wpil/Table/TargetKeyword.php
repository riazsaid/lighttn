...
class Wpil_Table_TargetKeyword extends WP_List_Table
{
    function get_columns()
    {
        ...
        if(in_array('ai-generated', $selected_sources, true)){
            $options['ai-generated'] = 
            '<div class="wpil-report-header-container">' . 
                __('AI Generated Keywords', 'wpil') . 
                '<div class="wpil-report-header-tooltip">
                    <div class="wpil_help">
                        <i class="dashicons dashicons-editor-help"></i>
                        <div class="wpil-help-text" style="display: none;">' . __('The AI Generated Keywords are the keywords that ChatGPT has created based on the post\'s content and Link Whisper can use when making link suggestions.', 'wpil') . '</div>
                    </div>
                </div>
            </div>';
        }
    ...
    function column_default($item, $column_name)
    {
        ...
        switch($column_name) {
            ...
            case 'post-content':
                ...
                return ob_get_clean();
            case 'ai-generated':
                $keywords = Wpil_TargetKeyword::get_post_keywords_by_type($post->id, $post->type, 'ai-generated-keyword');
    ...
    function get_sortable_columns()
    {
        return [
            ...
            'ai-generated'      => ['ai-generated', true],
            'date'              => ['date', false]
        ];
    }
    ...
    protected function single_row_columns( $item ) {
        ...
        foreach ( $columns as $column_name => $column_display_name ) {
            ...
            if(in_array($column_name, array('gsc', 'yoast', 'rank-math', 'aioseo', 'seopress', 'squirrly', 'post-content', 'ai-generated', 'custom'), true)){
